            ...
            5: {
                ...
                "exercises": [
                    ...
                    {"name": "Box Jump (Low)", "sets": 3, "reps": "6", "type": "plyometric",
                     "video": "HJZh-12p6vg", "instruction": "Stand in front of low box. Jump up landing softly with bent knees. Step down."},
                ],
            },
        },
    },
            ...
            1: {
                ...
                "exercises": [
                    ...
                    {"name": "Sciatic Nerve Glide", "sets": 2, "reps": "10 gentle", "type": "mobility",
                     "video": "XP1yzpFR6ho", "instruction": "Sit on chair. Slowly straighten affected leg while looking up. Bend knee while looking down. Gentle pendulum motion."},
                ],
            },
            2: {
                ...
                "exercises": [
                    {"name": "Press-Up (McKenzie Extension)", "sets": 3, "reps": "10", "type": "mobility",
                     "video": "8k-ZmkKm0DY", "instruction": "Lie face down. Push upper body up with arms, keeping hips on floor. Lower slowly. Stop if pain goes further down leg."},
                    ...
                    {"name": "Piriformis Stretch", "sets": 2, "reps": "30s each side", "type": "stretching",
                     "video": "jD1FYO3P4KQ", "instruction": "Lie on back. Cross affected leg over other knee. Pull bottom knee toward chest. Feel stretch deep in buttock."},
            ...
            3: {
                ...
                "exercises": [
                    ...
                    {"name": "Sciatic Nerve Floss (Advanced)", "sets": 2, "reps": "12", "type": "mobility",
                     "video": "XP1yzpFR6ho", "instruction": "Sit upright. Straighten leg fully while extending neck back. Bend knee while flexing neck forward. Smooth rhythm."},
                    {"name": "Modified Plank", "sets": 3, "reps": "20s hold", "type": "strengthening",
            ...
            2: {
                ...
                "exercises": [
                    ...
                    {"name": "Standing Hip Flexion", "sets": 2, "reps": "10 each side", "type": "mobility",
                     "video": "07_GSDtqUuQ", "instruction": "Stand holding chair. Lift knee toward chest. Lower with control. Maintain balance."},
            ...
            3: {
                ...
                "exercises": [
                    ...
                    {"name": "Standing Hip Extension", "sets": 3, "reps": "10 each side", "type": "strengthening",
                     "video": "07_GSDtqUuQ", "instruction": "Stand holding chair. Extend leg backward. Squeeze glute at top. Lower slowly."},
                ],
            },
            4: {
                "label": "Low Pain (VAS 1.0-3.4)",
                ...
                "exercises": [
                    ...
                    {"name": "Single-Leg Balance", "sets": 3, "reps": "30s each side", "type": "stability",
                     "video": "HwJUXz6jnkg", "instruction": "Stand on one leg. Maintain balance. Progress by closing eyes."},
                ],
            },
            5: {
                "label": "Minimal/No Pain (VAS 0-0.9)",
        ...
        "levels": {
            1: {
                ...
                "exercises": [
                    {"name": "Plantar Fascia Massage (Frozen Bottle)", "sets": 3, "reps": "5 min", "type": "mobility",
                     "video": "zP9Y7FKO8Mc", "instruction": "Roll frozen water bottle under foot. Apply gentle pressure. Combines ice therapy with massage."},
                    {"name": "Towel Stretch", "sets": 3, "reps": "30s hold", "type": "stretching",
                     "video": "rlAjIXb-8BM", "instruction": "Sit with leg extended. Loop towel around ball of foot. Pull towel gently toward you. Feel stretch in sole and calf."},
                    {"name": "Toe Curls (Towel Scrunch)", "sets": 2, "reps": "10", "type": "strengthening",
                     "video": "RoEmHev3KZ8", "instruction": "Sit with foot on towel. Scrunch towel toward you using toes. Strengthens intrinsic foot muscles."},
            ...
            2: {
                ...
                "exercises": [
                    ...
                    {"name": "Plantar Fascia Stretch", "sets": 3, "reps": "30s hold", "type": "stretching",
                     "video": "_3902auNid4", "instruction": "Sit and cross affected foot over knee. Pull toes back toward shin. Feel stretch along arch."},
                    {"name": "Marble Pick-Up", "sets": 2, "reps": "15", "type": "strengthening",
                     "video": "altJiiCZh0E", "instruction": "Place marbles on floor. Pick up with toes one at a time. Strengthens foot muscles."},
            ...
            3: {
                ...
                "exercises": [
                    ...
                    {"name": "Single-Leg Balance", "sets": 3, "reps": "30s each side", "type": "stability",
                     "video": "HwJUXz6jnkg", "instruction": "Stand on affected foot. Maintain balance. Strengthens foot stabilizers."},
            ...
            4: {
                ...
                "exercises": [
                    ...
                    {"name": "Toe Walking", "sets": 3, "reps": "20m", "type": "strengthening",
                     "video": "3d2S7a3D9YY", "instruction": "Walk on tiptoes for 20 meters. Strengthens calves and foot intrinsics."},
                    {"name": "Heel Walking", "sets": 3, "reps": "20m", "type": "strengthening",
                     "video": "aZ15aYKjx58", "instruction": "Walk on heels for 20 meters. Strengthens tibialis anterior. Builds foot control."},
                    {"name": "Mini Squat", "sets": 3, "reps": "12", "type": "strengthening",
            ...
            5: {
                ...
                "exercises": [
                    {"name": "Jump Rope (Low Impact)", "sets": 3, "reps": "30s", "type": "plyometric",
                     "video": "HJZh-12p6vg", "instruction": "Light jumping on toes. Build foot and calf endurance. Stop if any pain."},
                    {"name": "Single-Leg Hop", "sets": 3, "reps": "8 each side", "type": "plyometric",
                     "video": "nekKEq-6FiY", "instruction": "Small hops on one foot. Land softly. Tests readiness for running."},
                    ...
                    {"name": "Barefoot Walking on Grass", "sets": 1, "reps": "5 min", "type": "mobility",
                     "video": "mBYiD5hjSAg", "instruction": "Walk barefoot on soft grass. Stimulates foot proprioception. Natural foot strengthening."},
                ],
            },
        },
    },
            ...
            1: {
                ...
                "exercises": [
                    {"name": "Wrist Extensor Stretch", "sets": 3, "reps": "30s hold", "type": "stretching",
                     "video": "8w4WTfa2QEA", "instruction": "Extend arm straight. Palm facing down. Use other hand to gently bend wrist down. Feel stretch on outer forearm."},
                    {"name": "Wrist Flexor Stretch", "sets": 3, "reps": "30s hold", "type": "stretching",
                     "video": "8w4WTfa2QEA", "instruction": "Extend arm. Palm facing up. Use other hand to gently bend wrist down. Stretch inner forearm."},
                    {"name": "Fist Clench (Soft Ball)", "sets": 2, "reps": "10, hold 5s", "type": "strengthening",
                     "video": "yiLKITXCi8k", "instruction": "Squeeze a soft ball or rolled towel gently. Hold 5 seconds. Release. Very light resistance only."},
                    {"name": "Ice Massage", "sets": 3, "reps": "5 min", "type": "mobility",
                     "video": "8w4WTfa2QEA", "instruction": "Rub ice cup over outer elbow in circles for 5 minutes. Reduces inflammation."},
                ],
            },
            2: {
                "label": "Moderate (VAS 5.0-7.4)",
                ...
                "exercises": [
                    {"name": "Isometric Wrist Extension", "sets": 3, "reps": "8, hold 10s", "type": "strengthening",
                     "video": "Vhq7oGeRrDU", "instruction": "Rest forearm on table, wrist over edge. Push up against other hand without moving. Hold 10 seconds."},
                    {"name": "Isometric Wrist Flexion", "sets": 3, "reps": "8, hold 10s", "type": "strengthening",
                     "video": "ZuTTmToqh14", "instruction": "Rest forearm on table. Push wrist down against other hand without moving. Hold 10 seconds."},
                    {"name": "Wrist Extensor Stretch", "sets": 3, "reps": "30s hold", "type": "stretching",
                     "video": "8w4WTfa2QEA", "instruction": "Extend arm, palm down. Gently bend wrist down with other hand. Hold 30 seconds."},
                    {"name": "Supination/Pronation (No Weight)", "sets": 2, "reps": "10 each", "type": "mobility",
                     "video": "lrAWfBOMbMI", "instruction": "Rest forearm on table. Turn palm up then palm down slowly. Maintain elbow position."},
                ],
            },
            3: {
                "label": "Mild (VAS 3.5-4.9)",
                ...
                "exercises": [
                    {"name": "Eccentric Wrist Extension", "sets": 3, "reps": "12", "type": "strengthening",
                     "video": "upITc4ZveLU", "instruction": "Hold light weight, forearm on table. Use other hand to lift wrist up. Slowly lower under own power (3 seconds). Key exercise."},
                    {"name": "Wrist Curl (Light)", "sets": 3, "reps": "12", "type": "strengthening",
                     "video": "K2or0Rnufxs", "instruction": "Light dumbbell, forearm on table, palm up. Curl wrist up. Lower slowly."},
                    {"name": "Forearm Pronation/Supination (Hammer)", "sets": 3, "reps": "10 each", "type": "strengthening",
                     "video": "-LfyhlA9UNM", "instruction": "Hold hammer at end of handle. Slowly rotate forearm palm up then palm down. Hammer creates lever resistance."},
                    {"name": "Grip Strengthening (Towel Wring)", "sets": 2, "reps": "10", "type": "strengthening",
                     "video": "RY9EtLFpfko", "instruction": "Wring wet towel as if squeezing water out. Alternate directions. Functional grip exercise."},
                ],
            },
            4: {
                "label": "Low Pain (VAS 1.0-3.4)",
                ...
                "exercises": [
                    {"name": "Eccentric Wrist Extension (Heavier)", "sets": 3, "reps": "15", "type": "strengthening",
                     "video": "yTmEjQbWj8Q", "instruction": "Progress weight. Same eccentric lower technique. 3-second controlled descent."},
                    {"name": "Resistance Band Wrist Extension", "sets": 3, "reps": "15", "type": "strengthening",
                     "video": "zOlFpUujHAE", "instruction": "Step on band. Grip other end. Extend wrist against band resistance."},
                    {"name": "Ball Squeeze (Firm)", "sets": 3, "reps": "12, hold 5s", "type": "strengthening",
                     "video": "QIsXsK2FRbQ", "instruction": "Squeeze firm stress ball or tennis ball. Hold 5 seconds. Release. Build grip endurance."},
                    {"name": "Wrist Roller", "sets": 2, "reps": "3 rolls up/down", "type": "strengthening",
                     "video": "oWtRl_ysx08", "instruction": "Hold rod with weight on string. Roll weight up by rotating wrists. Lower slowly."},
                ],
            },
            5: {
                "label": "Minimal/No Pain (VAS 0-0.9)",
                ...
                "exercises": [
                    {"name": "Eccentric Wrist Extension (Progressive)", "sets": 3, "reps": "15", "type": "strengthening",
                     "video": "dsaOzSfsM24", "instruction": "Continue progressive loading. Maintain eccentric program for tendon health."},
                    ...
                    {"name": "Resistance Band Pronation/Supination", "sets": 3, "reps": "12 each", "type": "strengthening",
                     "video": "uxLwKX9BIkQ", "instruction": "Band resistance rotation exercises. Functional forearm strengthening."},
                    {"name": "Activity-Specific Training", "sets": 3, "reps": "as tolerated", "type": "strengthening",
                     "video": "imW5szzYXwc", "instruction": "Gradually return to specific activities (tennis, typing, gripping) with proper form and breaks."},
                ],
            },
        },
    },
